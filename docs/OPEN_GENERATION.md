# OPEN generation queue — everything still to make (single source of truth)

Scene/lesson art is COMPLETE: every object, every lesson cover, every scene is
drawn and live. What remains is below. Each block is self-contained — paste one
block into a fresh ChatGPT conversation. Filenames/cut targets shown per block.

=================================================================
## A. Finish the avatar adult recast  (2 blocks — HIGH priority)
=================================================================
Replaces the two female STANDING sprites that still read young.

### A1 — Aki adult standing  → replaces assets/story/people/aki-adult.png
```
Coloured manga-ink style: clean hand-drawn pen linework with soft grey pencil hatch shading. Only the CLOTHING is coloured; skin and hair stay black-ink line art on white. Flat solid chroma-key green background #00b140, even light, no cast shadow, no ground line. Draw ONE full-body character, front-facing, standing relaxed. She is a young ADULT WOMAN in her mid-20s with grown-up proportions - tall, roughly 7 heads high, long legs, a slim adult figure (NOT a child, NOT chibi, not big-headed). Mature but friendly face with normal-sized almond eyes and a warm smile. Shoulder-length wavy bob hair. She wears a RED / vermillion short-sleeve t-shirt with matching RED shorts, and is barefoot. Only the shirt and shorts are coloured red; everything else is black-ink linework.
```

### A2 — Beni adult standing  → replaces assets/story/people/beni-adult.png
```
Coloured manga-ink style: clean hand-drawn pen linework with soft grey pencil hatch shading. Only the CLOTHING is coloured; skin and hair stay black-ink line art on white. Flat solid chroma-key green background #00b140, even light, no cast shadow, no ground line. Draw ONE full-body character, front-facing, standing relaxed. She is a young ADULT WOMAN in her mid-20s with grown-up proportions - tall, roughly 7 heads high, long legs, a slim adult figure (NOT a child, NOT chibi, not big-headed). Mature but friendly face with normal-sized almond eyes, a soft smile, lightly blushed cheeks. Hair in a high SIDE PONYTAIL tied with a small ribbon. She wears a GOLDEN-AMBER / mustard-yellow short-sleeve A-line dress that falls to mid-thigh, and simple flat shoes. Only the dress is coloured amber; everything else is black-ink linework.
```

=================================================================
## B. Kana browse cards — 142 characters, 24 grids  (MEDIUM priority)
=================================================================
For the あア Kana browse/practice screen (Level 0). One block -> one 2x3 image;
each sliced into h-<romaji>.png / k-<romaji>.png. Do hiragana (H1-H12) then
katakana (K1-K12).
...
=================================================================
## C. OPTIONAL — kid / teen / old avatar action poses  (LOW priority)
=================================================================
Adult is the default stage and every non-adult scene falls back to that stage's
STANDING sprite, so this is pure polish. If wanted: for each of the 12 remaining
character-stages (aki/beni/kai/yuki x kid/teen/old), use the adult action-sheet
prompt but say 'draw them as a child / a teenager / an elderly person' and name
outputs <id>-<stage>-<action>. 12 sheets total.
